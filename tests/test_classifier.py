...
class TestUrgencyScorer:
    def test_high_urgency_crash(self):
        ...
        assert score_urgency(
            "The application keeps crashing every time I open it") == "High"
    ...
    def test_high_urgency_unauthorized_charge(self):
        ...
        assert score_urgency(
            "There is an unauthorized charge on my account") == "High"
    ...
    def test_medium_urgency_error(self):
        ...
        assert score_urgency(
            "I am seeing an error in the dashboard") == "Medium"
...
class TestSentimentAnalyzer:
    def test_negative_sentiment_angry(self):
        ...
        result = analyze_sentiment(
            "I am extremely frustrated with the terrible service")
        assert result == "Negative"

    def test_positive_sentiment_happy(self):
        """Satisfied customer should be Positive."""
        result = analyze_sentiment(
            "Thank you so much, the support was excellent and really helpful!")
...
class TestClassifier:
    ...
    def test_account_classification(self, model):
        ...
        from app.ml.classifier import predict_category
        result = predict_category(
            "I cannot log into my account and reset email is not arriving",
            model=model)
